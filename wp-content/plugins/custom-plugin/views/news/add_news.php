            ...
            <form action="" method="POST" enctype="multipart/form-data" id="form_berita">
                <div>
                    <div class="mb-4 d-flex justify-content-center">
                        <img id="output"
                            src="<?php echo get_template_directory_uri() . '/assets/img/default-image.png'; ?>"
                ...
                <div class="my-2">
                    ...
                    <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Berita Anda"
                        required>
                </div>
                <div class="my-2">
                    <label for="tag_cloud" class="form-label">Tag</label>
                    <input type="text" class="form-control p-0" id="tag_cloud" name="tag_cloud" required>
                </div>
                <div class="my-2">
                    <label for="kategori" class="form-label">Kategori</label>
                    <select class="form-control" name="kategoriValue" id="kategori" required>
